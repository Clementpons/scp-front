          ...
          <div className="p-4 md:p-8 rounded-lg  bg-white shadow-lg max-w-[750px] mx-auto -mb-[20vh] prose">
            ...
            <div>
              ...
              <p>
                ...
                serre-chevalier-parapente.fr. L’accès et la navigation sur le
                site impliquent l’acceptation pleine et entière des présentes
                CGU.
              </p>
              ...
              <p>
                ...
                d’un accès internet. Toutefois, certains services nécessitent
                une réservation et un paiement (voir CGV). L’éditeur du site se
                réserve le droit d’interrompre l’accès temporairement pour des
                raisons de maintenance ou de mise à jour.
              </p>

              <h2>4. CONTENUS ET PROPRIÉTÉ INTELLECTUELLE</h2>
              <p>
                L’ensemble des éléments du site (serre-chevalier-parapente.fr) –
                textes, images, graphismes, logos, vidéos, codes – est protégé
              ...
              <p>
                ...
                ou d’omissions. L’utilisation des informations fournies se fait
                sous la seule responsabilité de l’utilisateur.
              </p>
              <h3>5.2 Responsabilité de l’utilisateur</h3>
              <p>
                L’utilisateur s’engage à ne pas perturber le bon fonctionnement
                du site et à respecter les lois en vigueur. Tout usage
                frauduleux ou abusif pourra entraîner des sanctions et/ou la
                suspension de l’accès au site.
              </p>

              <h2>6. LIENS HYPERTEXTES</h2>
              <p>
                Le site peut contenir des liens vers des sites tiers. Serre
                Chevalier Parpaente ne saurait être tenu responsable du contenu
                ou de la politique de confidentialité de ces sites externes.
              </p>

              <h2>7. COOKIES ET DONNÉES PERSONNELLES</h2>
              <p>
                L’utilisateur est informé que des cookies analytiques sont
                utilisés pour améliorer l’expérience utilisateur. Pour plus
                d’informations, consulter la Politique de Confidentialité et la
                Politique de Cookies disponibles en pied de page.
              </p>

              <h2>8. MODIFICATION DES CGU</h2>
              <p>
                Serre Chevalier Parapente se réserve le droit de modifier les
                présentes CGU à tout moment. La version applicable est celle
                accessible en ligne à la date d’utilisation du site.
              </p>

              <h2>9. DROIT APPLICABLE ET JURIDICTION COMPÉTENTE</h2>
              <p>
                Les présentes CGU sont soumises au droit français. Tout litige
                sera soumis aux tribunaux compétents de Gap.
              </p>
            </div>
          </div>
        </div>
